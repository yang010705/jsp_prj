...
//session.setAttribute("cntFalg", true);
}//end if
...
<td><input type="text" name="subject" id="subject" value="${ bDTO.subject }" style="width: 520px; border: 1px solid #CDCDCD; height: 30px"></td>
</tr>
<tr>
<td>내용</td>
<td>
...
<tr>
<td>작성일</td>
<td><strong><fmt:formatDate value="${ bDTO.input_date }" pattern="yyyy-MM-dd a HH:mm"/></strong>( <c:out value="${ bDTO.ip }"/>)</td>
</tr>
<tr>
