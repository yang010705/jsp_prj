...
<style type="text/css">
 ...
 .span{font-weight:bold; color:#3D8E4A; font-size: 24px;}
  ...
  td:hover{background-color: #DEE2E6; cursor: pointer;}
</style>
<!-- jquery CDN -->
...
list.add(new DataDTO("img_3.jpg","이건 못참지!!","오전에 수고하셨고 점심","https://yogiyo.co.kr./mobile/#/"));
%>
<div>
<% for(DataDTO dto : list){ %>
<div class="card" style="width: 18rem; float:left; margin-right: 10px">
  <img style="width:300p; height: 160px;" src="http://192.168.10.70/jsp_prj/common/images/<%=dto.getImg() %>" class="card-img-top" alt="...">
  <div class="card-body">
