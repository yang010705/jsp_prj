...
<li><span>요청 서블렛명</span> : <%=request.getServletPath() %></li>
<li><span>요청 쿼리스트링</span> : <%=request.getQueryString() %></li>
<li><span>요청 파라미터</span> : <%=request.getParameter("name") %></li>
<li><span>요청 파라미터</span> : <%=request.getParameter("age") %></li>
...
<div>
<!-- use_request.jsp를 요청하면서 파라메터로 name=test, age=20을 query string을 아래 파라메터로 구성해보세요  
name=test, age=20-->
...
<input type="hidden" name="age" value="20232">
<input type="button" value="POST 방식의 요청" id="btn">
</form>
</div>
</div>
</main>
