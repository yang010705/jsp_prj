			...
			success : function(jsonArr){
				...
				<table class='table table-hover'>
				 ...
				 $.each(jsonArr, function(i, jsonObj){
					 table+="<tr><td>" + (i+1) + "</td><td>" + jsonObj.deptno + "</td><td>" + jsonObj.dname + "</td><td>" + jsonObj.loc + "</td></tr>"; 
				 })
				 table += `</tbody>
				 		   </table>`;
				$("#output").html(table);
...
<input type="button" value="부서정보추가" class="btn btn-success" id="btn2">
