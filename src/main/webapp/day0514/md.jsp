...
<c:import url="http://192.168.10.68/jsp_prj/common/jsp/external_file.jsp"/>
<style type="text/css">
...
<c:import url="http://192.168.10.68/jsp_prj/common/jsp/header.jsp"/>
</header>
<main>
<div id="container">
<%
...
<c:import url="http://192.168.10.68/jsp_prj/common/jsp/footer.jsp"/>
</footer>
